...
function viewStudentStats(id, toggle){ //bug found where not all menues colapse when the toggle is switched to 0
...
function switchPlayers(playerNum){
	...
	var avg_p_yards = (document.getElementById("p_yards").innerHTML)/(document.getElementById("g_played").innerHTML);

	var avg_r_yards = (document.getElementById("r_yards").innerHTML)/(document.getElementById("g_played").innerHTML);

	var avg_rec_yards = (document.getElementById("rec_yards").innerHTML)/(document.getElementById("g_played").innerHTML);
